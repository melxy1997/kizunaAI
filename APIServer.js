...
server.get('/setFlag', (req, res, next) => {
    ...
    // console.log('/setFlag', req.query.value);
...
server.get('/getGifURL', (req, res, next) => {
    //小程序调用
    /* 访问数据库 */
    // gifURL = 'http://img2.biaoqingjia.com/biaoqing/201707/fc7acc977172dd3f6f1ed4ca190e97eb.gif'
    gifURL = 'true_exam.gif'
